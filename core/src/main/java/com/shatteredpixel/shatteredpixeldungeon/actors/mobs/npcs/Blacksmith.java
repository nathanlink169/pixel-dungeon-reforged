...
public class Blacksmith extends NPC {
	@Override
	public Constants.mobs.mobsBase GetConstants() { return Constants.mobs.blacksmith; }
	...
	public boolean interact(Char c) {
		...
		if (!Quest.given) {
			...
			switch (Dungeon.hero.heroClass){
				...
				case ARTIFICER: msg1 += Messages.get(Blacksmith.this, "intro_quest_artificer"); break;
			}
			...
			switch (Quest.type){
				...
				case Quest.KOBOLD:  msg2 += Messages.get(Blacksmith.this, "intro_quest_kobold"); break;
			}
			...
			switch (Quest.type){
				...
				case Quest.KOBOLD:   msg += Messages.get(Blacksmith.this, "reminder_kobold"); break;
			}
			tell(msg);
	...
	public static class Quest {
		...
		public static final int KOBOLD = 4;
