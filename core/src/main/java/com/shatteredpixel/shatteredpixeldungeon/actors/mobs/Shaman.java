...
public abstract class Shaman extends Mob {
	@Override
	public int GetMaxHP() {
		if (getRandomizerEnabled(RandomTraits.FRAIL_CASTERS)) return 1;
	...
	public float GetLootChance(int slot) {
		...
		return super.GetLootChance(slot) * (float)Math.pow(1/3f, Dungeon.LimitedDrops.SHAMAN_WAND.count);
	}
	...
	public static class BlueShaman extends Shaman {
		@Override
		public Constants.mobs.mobsBase GetConstants() { return Constants.mobs.blueshaman; }
	...
	public static class PurpleShaman extends Shaman {
		@Override
		public Constants.mobs.mobsBase GetConstants() { return Constants.mobs.purpleshaman; }
