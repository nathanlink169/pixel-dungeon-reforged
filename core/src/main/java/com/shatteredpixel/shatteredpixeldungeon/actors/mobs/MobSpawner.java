		...
		switch(depth){
			...
			case 2:
				...
				return new ArrayList<>(Arrays.asList(Rat.class, Rat.class,
						...
						Spitter.class));
			case 3:
				//1x rat, 1x snake, 3x gnoll, 1x swarm, 1x crab, 1x Spitter
				return new ArrayList<>(Arrays.asList(Rat.class,
						...
						Spitter.class));
			case 4: case 5:
				//1x gnoll, 1x swarm, 2x crab, 2x slime, 1x Spitter
			...
			case 6:
				...
				return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class, Skeleton.class,
						...
						Swarm.class));
			case 7:
				//3x skeleton, 1x thief, 1x DM-100, 1x guard, 1x Unholy Priest
				return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class, Skeleton.class,
						Thief.class,
						DM100.class,
						Guard.class,
						UnholyPriest.class));
			case 8:
				//2x skeleton, 1x thief, 2x DM-100, 2x guard, 1x necromancer, 1x Unholy Priest
				return new ArrayList<>(Arrays.asList(Skeleton.class, Skeleton.class,
						...
						UnholyPriest.class));
			case 9: case 10:
				//1x skeleton, 1x thief, 2x DM-100, 2x guard, 2x necromancer, 1x Unholy Priest
			...
			// Caves
			case 11:
				//3x bat, 1x brute, 1x shaman, 1x Unholy Priest
				return new ArrayList<>(Arrays.asList(
