...
public class Dungeon {
	...
	public static int Boss1Version;
	public static int Boss2Version;
	public static int Boss3Version;
	public static int Boss4Version;
	...
	private static final String BOSS_1_VERSION	= "boss_1_version";
	private static final String BOSS_2_VERSION	= "boss_2_version";
	private static final String BOSS_3_VERSION	= "boss_3_version";
	private static final String BOSS_4_VERSION	= "boss_4_version";
	...
	public static void saveGame( int save ) {
		try {
			...
			bundle.put( BOSS_1_VERSION, Boss1Version);
			bundle.put( BOSS_2_VERSION, Boss2Version);
	...
	public static void loadGame( int save, boolean fullLoad ) throws IOException {
		...
		Boss3Version = bundle.getInt( BOSS_3_VERSION );
		Boss4Version = bundle.getInt( BOSS_4_VERSION );
