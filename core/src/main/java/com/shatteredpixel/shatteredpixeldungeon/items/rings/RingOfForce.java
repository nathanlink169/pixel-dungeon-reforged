...
public class RingOfForce extends Ring {
	...
	public static int damageRoll( Hero hero ){
		if (hero.buff(Force.class) != null
			...
			int level = (int)getBuffedBonus(hero, Force.class);
	...
	public String info() {
		...
		if (Dungeon.hero != null && Dungeon.hero.heroClass == HeroClass.DUELIST
			...
			int level = isIdentified() ? (isEquipped(Dungeon.hero) ? (int)getBuffedBonus(Dungeon.hero, Force.class) : soloBuffedBonus()) : 0;
